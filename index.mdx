...
<div className="group relative flex flex-col rounded-xl border overflow-hidden hover:shadow-md transition">
  ...
  <a href="/world-chain/index" className="group flex flex-col rounded-xl border overflow-hidden hover:shadow-md transition no-underline hover:no-underline" aria-label="World Chain">
    <img
