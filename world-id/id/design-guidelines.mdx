...
<img src="/images/docs/id/design-guidelines/main.png" alt="Default state - Waiting for user to scan the QR code" width="600" height="400" className="w-full h-auto max-w-[600px]" />

**Success** - Successful connection

<img src="/images/docs/id/design-guidelines/success.png" alt="Success - Successful connection" width="600" height="400" className="w-full h-auto max-w-[600px]" />

**Request canceled** - User manually canceled request in World App

<img src="/images/docs/id/design-guidelines/cancel.png" alt="Request canceled - User manually canceled request in World App" width="600" height="400" className="w-full h-auto max-w-[600px]" />

**Connection lost** - Lost connection to server or user offline

<img src="/images/docs/id/design-guidelines/lost.png" alt="Connection lost - Lost connection to server or user offline" width="600" height="400" className="w-full h-auto max-w-[600px]" />

**Error** - Generic technical error or proof failure

<img src="/images/docs/id/design-guidelines/error.png" alt="Error - Generic technical error or proof failure" width="600" height="400" className="w-full h-auto max-w-[600px]" />

### Partnership example

<img src="/images/docs/id/design-guidelines/partner.png" alt="Partnership example" width="600" height="400" className="w-full h-auto max-w-[600px]" />
