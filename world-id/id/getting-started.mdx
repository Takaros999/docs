...
<Note>
Find a full list of supported SDKs [here](./libraries)
</Note>
...
<Note>
Cloud verifications from the Developer portal automatically handle sybil-resistance for you, ensuring that a user cannot perform the same action more than a set amount. If you want to verify proofs on-chain you need to handle this, more details [here](./on-chain)
</Note>