...
<div style="display: flex; flex-direction: column; align-items: center;">
  <img src="/images/docs/mini-apps/quick-start/template.png" alt="Template" width="300" height="700" />
  <p style="font-style: italic; margin-top: 0.5rem;">Correctly running template should look like this</p>
</div>
