...
<div style={{ position: 'relative', width: '100%' }}>
    <img
        ...
        style={{ position: 'absolute', width: '100%', maxWidth: '600px', zIndex: 1, borderRadius: '12px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}
    />
    <img
        src="/images/docs/mini-apps/quick-actions/sage2-qa.png"
        alt="Sage Developer Dashboard Settings"
        style={{ position: 'relative', width: '100%', maxWidth: '600px', marginLeft: '33%', zIndex: 2, borderRadius: '12px', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.15)' }}
    />
</div>
...
<Note>
The Support Link Generator component would be inserted here in the actual implementation.
</Note>